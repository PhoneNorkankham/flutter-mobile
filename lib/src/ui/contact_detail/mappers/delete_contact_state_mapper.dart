...
class DeleteContactStateMapper implements BaseStateMapper<ContactDetailState, VoidResult> {
  @override
  ContactDetailState mapResultToState(ContactDetailState state, VoidResult result) {
    if (result.isError) {
